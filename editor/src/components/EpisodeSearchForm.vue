        ...
        <div class="max-w-4xl mx-auto px-3 sm:px-4 space-y-4 sm:space-y-6">
            ...
            <div v-if="activeTab === 'search'" class="space-y-6">
                <div class="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
                    ...
                    <div
                        class="mt-4 flex flex-col-reverse sm:flex-row sm:justify-between sm:items-center gap-3"
                    >
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex sm:justify-end">
                            ...
                            >
                                ...
                                {{
                                    manualLoading
                                        ? t("episodeSearch.processing")
                                        : t("episodeSearch.extractEpisodes")
                                }}
                            </button>
                        </div>
                    </div>
...
async function handleEpisodeSelect(episodeInput: unknown) {
    ...
    try {
        ...
        if (!episode.checksum) {
            ...
            rssEpisode =
                metadataResponse.podcastMetadata.episodes.find((ep) => ep.guid === episodeGuid) ||
